        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-6">
              <a href="https://www.instagram.com/dishu_studio_wedding" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#D4AF37] transition-colors" data-testid="footer-social-instagram" aria-label="Instagram">
                <Instagram className="h-5 w-5" strokeWidth={1.5} />
              </a>
              <a href="https://wa.me/919723861620" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#D4AF37] transition-colors" data-testid="footer-social-whatsapp" aria-label="WhatsApp">
